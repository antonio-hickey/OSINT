...
def Indian_Base():
    ...
    # Take Screenshot
    time.sleep(2)
    driver.save_screenshot('/home/sratus/Desktop/OSINT/Expiramental-6-27-20/Satellite Images By Region/India' + date_string + '.png')
...
def China_Base():
    ...
    # Take Screenshot
    time.sleep(2)
    driver.save_screenshot('/home/sratus/Desktop/OSINT/Expiramental-6-27-20/Satellite Images By Region/China-' + date_string + '.png')
